...
\centering
\includegraphics[width=0.95\textwidth, keepaspectratio=true]{figs/neutrinoScattering.png}
\end{figure}
...
\centering
\includegraphics[width=0.28\textwidth, keepaspectratio=true]{figs/NeutronBetaDecay.png}\includegraphics[width=0.28\textwidth, keepaspectratio=true]{figs/MuonDecay.png}
\end{SCfigure}
