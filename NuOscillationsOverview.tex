...
According Particle Data Group Review \cite{ref_PDG} the following questions will be the main priority to answer by current and future neutrino experiments:
\begin{itemize}
